...
pall <- wrap_elements(labs, clip = F) + wrap_elements(pall1, clip = F) + wrap_elements(pall2, clip = F) + wrap_elements(pint, clip = F) +
  plot_layout(nrow = 1, widths = c(2.3, 4.2, 4.2, 2))
