...
kmfunc <- function(data = rsdata, impdata = imprsdata, time, event, eventname, novar = NULL,
  ...
  p <- ggplot(plot_data, aes(x = time / 30.5, y = estimate, color = strata)) +
    ...
    annotate("text",
      x = textadjx, y = c(textadjy, textadjy - 0.1, textadjy - 0.2, textadjy - 0.3), label = c("", levs),
      hjust = 0, size = 6, fontface = "bold", colour = c("black", global_cols[3:1])
    ) +
    annotate("text",
      x = textadjx + 3.2, y = c(textadjy, textadjy - 0.1, textadjy - 0.2, textadjy - 0.3), label = cox_crude,
      hjust = 0.5, size = 6, fontface = "bold", colour = c("black", global_cols[3:1])
    ) +
    annotate("text",
      x = textadjx + 6.5, y = c(textadjy, textadjy - 0.1, textadjy - 0.2, textadjy - 0.3), label = cox_adj,
      hjust = 0.5, size = 6, fontface = "bold", colour = c("black", global_cols[3:1])
    )
