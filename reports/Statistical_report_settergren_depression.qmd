...
Time to first events were presented with cumulative incidence curves by anxiety/depression 
for the primary outcome, all-cause death. Separate figures were also performed for the respective EF groups. 
...
respective variable for the primary outcome and presented in a Forest plot. FIXA: Location, age, sex, utbildning, inkomst, barn, om man bor ensam, ckd, ef, hfduration, nyha, ntprobnp, stroke. 
