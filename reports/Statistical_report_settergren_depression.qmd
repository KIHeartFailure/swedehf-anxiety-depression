---
title: "Statistical report: Anxiety/depression across the EF spectrum: an analysis from the Swedish Heart Failure Registry"
subtitle: Draft
date: "`r Sys.Date()`"
...
SwedeHF was linked with national Swedish registries (SHFDB v 4.1.2) through the 
...
1. None = "Jag är inte orolig eller nedstämd"
2. Moderate = "Jag är orolig eller nedstämd i viss utsträckning"
3. Severe = "Jag är i högsta grad orolig eller nedstämd"
...
TO DO: Skicka projektansökan till swedehf styrgrupp. Slå ihop med QoL projekansökan?
...
Variables included in the model are indicated in @tbl-base. Anxiety/depression was not included in the model. 
...
Baseline characteristics are presented by anxiety/depression. 
...
FRÅGA: Kolla noga igenom variabler i tabell, ska några läggas till? Kontrollera även regressions variabler, lägga till? Ta bort?

## Independent associations between baseline characteristics and anxiety/depression

The association between baseline characteristics and anxiety/depression was evaluated using a multivariable multinominal regression 
...
FRÅGA: Ska out of breath mm (övriga qol variabler) justeras för???? Mycket samvariation antar jag (detta är ju också känslofrågor, så om man är deprimerad uppfattar man ju att man är sämre gällande andfåddhet, och sämre andfåddhet gör ju att man blir deppad). 

FRÅGA: Ska detta göras uppdelat på EF (så associationer mellan anxiety/depression och baseline char INOM respektive EF grupp)? 
...
## Association between outcomes and anxiety/depression
...
Time to first events were presented with cumulative incidence curves by anxiety/depression. Separate figures were also performed for the respective EF groups. 
...
FRÅGA: SKA KLIPPA TID VID 5 ÅR?  1ÅR? 10 år? Aldrig? 

Fråga: Är val av utfall OK?

### Association between outcomes and anxiety/depression - Subgroups

Associations across pre-specified subgroups were evaluated using an interaction term between anxiety/depression and the 
respective variable for the primary outcome and presented in a Forest plot. 

FRÅGA: Ska göras för alla utfall eller räcker med primärt utfall?
FRÅGA: Om alla utfall, FUNDERA PÅ ATT EV TA BORT utfallstab uppdelat på EF. Finns i Subgrupps forestplot. note to self: ändra då KM fig så tas från interaktionsmodell och inte subgrupper. 
...
https://github.com/KIHeartFailure/swedehf-anxiety-depression. On publication
