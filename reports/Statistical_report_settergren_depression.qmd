...
including the variables indicated in @tbl-base (all shown in the Forestplots). The variables were selected based on clinical relevance. 
A consistency analyses was performed excluding the 6 other QoL variables, `r paste0(qolvars, collapse = ", ")`.
...
Time to first events were presented with cumulative incidence curves by anxiety/depression. Separate figures were also performed for the respective EF groups and in/out-patients. 
...
Data were censored at `r global_followup_months` months follow-up, 2023-12-31 or emigration from Sweden. 
